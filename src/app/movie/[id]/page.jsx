  ...
  try {
    ...
    return (
      <div className='text-center mt-12'>
        <h1 className='text-2xl font-bold text-gray-900 dark:text-white'>Error fetching movie details</h1>
        <p className='text-gray-900 dark:text-white'>{error.message}</p>
      </div>
    );
  }
            ...
            <div className='grid grid-cols-1 min-[400px]:grid-cols-2 mt-4 sm:grid-cols-3'>
              ...
              <div className=''>
                ...
                <div className='flex items-start gap-2'>
                  <TbCategoryPlus />
                  <div className='flex items-center gap-3 flex-wrap'>{genre}</div>
                </div>
              </div>
              <div className=''>
